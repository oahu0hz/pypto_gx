...
d: pl.Tensor[[64, 128], pl.FP32, [128, 1]] # With explicit stride
e: pl.Tensor[[64, 128], pl.FP32, pl.NZ, [128, 1]]  # With layout + stride
...
Explicit stride overrides the default row-major stride computed by codegen. Stride elements map one-to-one with shape dimensions.
